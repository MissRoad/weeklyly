...
public class DateUtilsPlus {
    ...
    /**
     * 根据指定日期计算所在周的周一和周日的日期
     *
     * @param date     日期
     * @param whichDay 想取周一日期则传1，周日日期则传7
     * @return
     */
    public static String getMondayOrSunday(Date date, Integer whichDay) {
    ...
    public static void main(String[] args) {
        Date date = new Date();
        date.setTime(1547708918000L);
        String mondayOrSunday = getMondayOrSunday(date, MONDAY);
        System.out.println(mondayOrSunday);
    }
}
