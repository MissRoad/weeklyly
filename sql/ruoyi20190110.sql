...
-- ----------------------------
INSERT INTO `qrtz_scheduler_state` VALUES ('RuoyiScheduler', 'NEC-SH00350911547114634982', 1547114729044, 15000);
...
) ENGINE = InnoDB AUTO_INCREMENT = 151 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统访问记录' ROW_FORMAT = Dynamic;
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 103, 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '29c67a30398638269fe600f73a054934', '111111', '0', '0', '127.0.0.1', '2019-01-10 18:04:33', 'admin', '2018-03-16 11:33:00', 'ry', '2019-01-10 18:04:33', '管理员');
...
-- ----------------------------
INSERT INTO `sys_user_online` VALUES ('4259b3a0-e2be-44a9-911b-26beaebbb633', 'admin', '研发部门', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', 'on_line', '2019-01-10 17:42:03', '2019-01-10 18:04:34', 1800000);
...
CREATE TABLE `weekly`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '周报' ROW_FORMAT = Dynamic;
